...
class JobsList extends Component {
  ...
  changePage = (pageDirection, numberOfPages = 1) => {
    ...
    switch (pageDirection) {
      case 'first': page = 1;
        break;
      case 'prev': page = parseInt(this.state.page) - 1;
        break;
      case 'next': page = parseInt(this.state.page) + 1
        break;
      case 'last': page = numberOfPages;
        break;
      default: break;
    }

    let query1 = queryString.stringify({ page })
    this.setState({ page });
  ...
  render() {
    ...
    return (
      ...
      <div className={styles.list}>
        <Pagination page = {this.state.page} changePage = {this.changePage} numberOfPages= {numberOfPages}/>
